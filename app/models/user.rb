class User < ApplicationRecord
  ...
  validates :last_name, presence: true, format: { with: /\A[ぁ-んァ-ン一-龥]+\z/, message: "はひらがな、カタカナ、漢字のみ使用できます" }
  validates :first_name, presence: true, format: { with: /\A[ぁ-んァ-ン一-龥]+\z/, message: "はひらがな、カタカナ、漢字のみ使用できます" }
